...
//!    the correct `working_dir` (`repo_root/.makina/worktrees/{plan_slug}--{task_id}`), `run_id`
...
///    - `working_dir == repo_root/.makina/worktrees/audit-plan--audit-task`
