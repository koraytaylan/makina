...
|---|---|---|---|
| 0001 | Theme Core Abstraction | `theme-module-core`, `app-active-theme-field` | 📋 Planned |
| 0002 | Render Module Migration | `ui-migrate-colors`, `ansi-migrate-colors`, `selection-migrate-colors` | 📋 Planned |
| 0003 | Command Palette Theme Switcher | `palette-theme-switcher` | 📋 Planned |
| 0004 | Theme Persistence & Startup | `globalconfig-theme-name`, `theme-load-startup`, `theme-commit-selection`, `theme-validation-test` | 📋 Planned |
