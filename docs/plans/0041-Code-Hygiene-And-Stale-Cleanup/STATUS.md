...
|---|---|---|---|
| 0001 | Shared-Helper-Extraction | `extract-drain-agent-turn`, `extract-combine-output` | ✅ Done |
| 0002 | Atomicity-And-Doc-Fixes | `atomicity-run-json`, `fix-state-machine-docs`, `fix-run-metadata-docs` | ✅ Done |
| 0003 | Dead-Code-Cleanup-And-Deduplication | `remove-stale-dead-code-allows`, `deduplicate-settings-validation`, `resolve-stub-events` | ✅ Done |
