...
| 0047 | Project Scaffolding Command — makina create <path> [--template <name>] | 📋 Planned | 0/6 | A headless `makina create <path> [--template todo]` subcommand scaffolds a brand-new, immediately-runnable experiment project outside the makina repo, giving outside developers a zero-risk first run. | [status](0047-Makina-Create-Project-Scaffolding-Command/STATUS.md) |
